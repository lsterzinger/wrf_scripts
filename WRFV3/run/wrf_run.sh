...
echo " start_hour = 00, 00, 00, 00," >> namelist.input
...
echo " end_hour = 00, 00, 00, 00," >> namelist.input
echo " end_minute = 00, 00, 00, 00," >> namelist.input
echo " end_second = 00, 00, 00, 00," >> namelist.input
