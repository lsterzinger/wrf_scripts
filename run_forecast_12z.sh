...
then
  ...
  mkdir $BASE_DIR/DATA/nam/212_12z/$today
  cd $BASE_DIR/DATA/nam/212_12z/$today
  $BASE_DIR/DATA/nam/212_12z/get12Z.sh $today >& $BASE_DIR/DATA/nam/212_12z/get12Z.log
  cd $BASE_DIR

  cd WPS
  ./wrf_init.12z.sh $today
  cd ..
fi
